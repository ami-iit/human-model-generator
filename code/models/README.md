...
The Human Model Generator (HMG) models the human musculoskeletal system as a rigid multi-body system with 23 links connected by 22 joints and 22 muscles, 11 bilaterally, using their points of origin and insertion in the body. The model includes articulated fingers on both hands, adding 30 finger links and 30 finger joints to the kinematic structure, for a kinematic total of 53 links and 52 joints. The modeling is done using simple geometric shapes like parallelepipeds, cylinders, and spheres, which are automatically scaled based on anthropometric parameters like total height, total mass, and specific circumferences. Additional meshes have been added to model the spinal cord from the pelvis to the neck. A total of 97 meshes, of which 30 belong only to the fingers, for links, muscles, and bones are added to the body to represent the structure more accurately.
