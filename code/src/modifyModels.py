...
def modifyLinkDimension(linkDimensions, robot):
    ...
    finger_lengths = {
        ...
        "middle_1": 0.55 * finger_reach,
        "middle_2": 0.45 * finger_reach,
        "ring_1": 0.55 * 0.94 * finger_reach,
        "ring_2": 0.45 * 0.94 * finger_reach,
        "pinkie_1": 0.55 * 0.82 * finger_reach,
        "pinkie_2": 0.45 * 0.82 * finger_reach,
        "thumb_1": 0.45 * 0.70 * finger_reach,
        "thumb_2": 0.32 * 0.70 * finger_reach,
        "thumb_3": 0.23 * 0.70 * finger_reach,
    }
